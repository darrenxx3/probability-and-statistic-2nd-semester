...
# Variabel .... (isi dengan mengikuti/ tidak mengikuti) distribusi Gaussian
# Variabel .... (isi dengan mengikuti/ tidak mengikuti) distribusi Gaussian
# Variabel .... (isi dengan mengikuti/ tidak mengikuti) distribusi Gaussian
# Variabel .... (isi dengan mengikuti/ tidak mengikuti) distribusi Gaussian
...
# Hasil uji hipotesa .... (isi dengan signifikan/ tidak signifikan) pada alfa 0,1. 
# p-value = .... (isi dengan =, atau < atau > ) alpha = 0,1 
# Hipotesa null .... (isi dengan ditolak/ tidak ditolak) pada tingkat signifikansi 0.1
# Kesimpulan: data pada sampel ... (isi dengan menunjukkan cukup bukti/ tidak cukup bukti)
# bahwa mean AnnualFoodSpending lokasi 1 .... (isi dengan sama/ tidak sama dengan) 10000 USD.

#d----



# mu_0 = 10000 .... (isi dengan termasuk/ tidak termasuk) dalam selang kepercayaan .... (copy paste nilai selang kepercayaan di sini).
# Hipotesa null (H_0) ... (isi dengan ditolak/ tidak ditolak) pada tingkat signifikansi 0,1. 
# Kesimpulan yang didapatkan dengan memeriksa selang kepercayaan
# ... (isi dengan konsisten/ tidak konsisten) 
# dengan kesimpulan yang didapatkan dari uji hipotesa, yaitu
# data pada sampel menunjukkan ... (isi dengan cukup bukti/ tidak cukup bukti) 
...
# KESIMPULAN
# p-value = ...... (copy paste p-value dari output dan isi dengan =, < atau >) alpha = 0,1
# ... (isi dengan Terdapat cukup bukti/ tidak cukup bukti) untuk menolak H0 pada tingkat signifikansi 10%.
# KESIMPULAN: mean populasi AnnualFoodSpending .... 10000 USD.
```
